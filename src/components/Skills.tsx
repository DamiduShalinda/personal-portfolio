...
const Skills:React.FC = () => {
  return (
    <div id="skills" className='w-full h-screen bg-primary'>
            {/* container */}
            ...
            <div className='grid sm:grid-cols-4 grid-cols-3 text-center text-white py-8 gap-5'>
                <div className='flex flex-col items-center justify-center shadow-md shadow-[#040c16] rounded-md hover:scale-110 duration-500  pt-4'>
